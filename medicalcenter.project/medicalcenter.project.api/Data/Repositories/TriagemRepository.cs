...
{
    public class TriagemRepository : BaseRepository<TriagemEntity>, ITriagemRepository
    {
        public TriagemRepository( SqlServerDbContext context )
            : base( context )
        {
        }
        ...
        public async Task<TriagemEntity> GetByIdAsync( Guid id )
        {
            try
            {
